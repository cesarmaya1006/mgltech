            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.mensaje == "ok") {
                        ...
                        Sistema.notificaciones(aviso + " fue cargado correctamente","Sistema","success");
                    } else {
                        Sistema.notificaciones(aviso + " no pudo ser cargado","Sistema","error");
                    }
                },
                error: function() {
