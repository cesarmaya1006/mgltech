...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="#">Documentos contractuales</a></li>
@endsection
@section('titulo_card')
<img src="{{asset('imagenes/sistema/9.png')}}" class="img-fluid" alt="..." style="max-height: 35px; width: auto;"> Documentos contractuales
@endsection
...
@section('cuerpoPagina')
    @can('documentos_contractuales.index')
        <div class="row">
            ...
            <div class="col-12 col-md-3 form-group">
                ...
                @else
                    ...
                    @else
                        @if ($grupos->count()==1)
                            <select id="empresa_id" class="form-control form-control-sm" data_url="{{ route('documentos_contractuales.getCargarEmpleadosEmpresa') }}">
        ...
        <div class="row">
            <div class="col-12 table-responsive" style="font-size: 0.85em;">
                <table class="table display table-striped table-hover table-sm" id="tablaDocumentos">
                    <thead>
                        <tr>
...
<div class="row">
    <div class="col-12">
        <input type="hidden" id="datosUpLaod"
                data_soportes="{{route('documentos_contractuales.getDocumentosContractuales')}}"
                data_url="{{route('documentos_contractuales.setDocumentosContractuales')}}"
                ruta_soporte="{{asset('documentos/soportes') . '/'}}">
        <input type="hidden" id="borrarSoportes" data_url="{{route('documentos_contractuales.eliminarDocumentosContractuales')}}">
        @csrf
    </div>
</div>
<!-- Modal addManual -->
...
@section('script_pagina')
    ...
    <script src="{{ asset('js/intranet/empresa/modulo_archivo/doc_contractuales/index.js') }}"></script>
@endsection
