                    ...
                    @else
                        @if ($grupos->count()==1)
                            <select id="empresa_id" class="form-control form-control-sm"
                                    data_url="{{ route('vacaciones.getCargarEmpleadosEmpresa') }}">
...
<div class="row">
    <div class="col-12">
        <input type="hidden" id="datosUpLaod"
                data_soportes="{{route('vacaciones.getSoportes')}}"
                data_url="{{route('vacaciones.setSoportes')}}"
                ruta_soporte="{{asset('documentos/soportes') . '/'}}"
                tabla ="tablaSoportes"
                tbody ="tbody_Soportes"
                tipoSoporte ="Vacaciones"
                titulo ="Ingrese el soporte de Vacaciones y/o licencias"
                aviso ="El soporte de Vacaciones y/o licencias">
        <input type="hidden" id="borrarSoportes" data_url="{{route('vacaciones.eliminarSoportes')}}">
        @csrf
    </div>
</div>
<!-- Modal addManual -->
