...
class SitLabGenController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('intranet.empresa.modulo_archivo.sit_lab_gen.index', compact('grupos', 'usuario'));
    }
    ...
    public function getDocumentosContractuales(Request $request)
    {
        if ($request->ajax()) {
            $empleado_id = $_GET['id'];
            $soportes = SoporteAarchivoEmpleado::where('tipo','SitLabGen')->where('empleado_id',$empleado_id)->get();
