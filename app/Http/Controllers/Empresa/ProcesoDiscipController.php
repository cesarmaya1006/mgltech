...
class ProcesoDiscipController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('intranet.empresa.modulo_archivo.proceso_discip.index', compact('grupos', 'usuario'));
    }
    ...
    public function getSoportes(Request $request)
    {
        if ($request->ajax()) {
            $empleado_id = $_GET['id'];
            $soportes = SoporteAarchivoEmpleado::where('tipo','ProcesoDiscip')->where('empleado_id',$empleado_id)->get();
