...
class DocumentosContractualesController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('intranet.empresa.modulo_archivo.doc_contractuales.index', compact('grupos', 'usuario'));
    }
    ...
    public function getDocumentosContractuales(Request $request)
    {
        if ($request->ajax()) {
            $empleado_id = $_GET['id'];
            $soportes = SoporteAarchivoEmpleado::where('tipo','documentosContractuales')->where('empleado_id',$empleado_id)->get();
    ...
    public function setDocumentosContractuales(Request $request)
    {
        if ($request->ajax()) {
            ...
            $soporte['tipo'] = 'documentosContractuales';
